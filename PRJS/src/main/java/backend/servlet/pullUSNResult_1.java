 ...
 */
public class pullUSNResult_1 extends HttpServlet {
	private static final long serialVersionUID = 1L;
	MongoClient mongoClient;
    /**
     * @see HttpServlet#HttpServlet()
     */
    public pullUSNResult_1() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		for(Object i:list){
			...
			// Old implementation, checking for improvment
			/*
			...
			for(Object i2:list2){
				...
				list3.add(subjectresult_reco.get("Cie").toString());
				list3.add(subjectresult_reco.get("See").toString());
				list3.add(subjectresult_reco.get("Grade").toString());
			}
			*/
			...
			for(Object i2:list2){
				...
				Object temp2= subjectresult_reco.get("Course_id");
				Document course_reco= collection1.find(eq("_id",temp2.toString())).first();
				list3.put(course_reco.get("Course_name").toString());
				list3.put(subjectresult_reco.get("Cie").toString());
				list3.put(subjectresult_reco.get("See").toString());
				list3.put(subjectresult_reco.get("Grade").toString());
			}
			try {
				semresult.put("COURSESTAKEN",list3);
